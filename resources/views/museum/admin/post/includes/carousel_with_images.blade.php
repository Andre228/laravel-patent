...
<div class="row" style="margin-top: 20px;
    ...
    <div class="col">
        <div class="collapse multi-collapse" id="multiCollapseExample1">
            <form method="POST" action="{{route('museum.admin.images.update', $item->id)}}" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <input type="file" name="image" class="btn btn-dark">
                <button class="btn btn-dark" type="submit" style=""  aria-hidden="true">
                    <i class="fas fa-save fa-2x"></i> Сохранить изображение
                </button>
            </form>
                        ...
                        @for($i = 0; $i < count($imagelist); $i++)
                            <div class="carousel-item @if($i === 0) active @endif" style="height: 500px" >
                                <form method="POST" id="destroy-form" action="{{route('museum.admin.images.destroy', $imagelist[$i]->id)}}">
                                    ...
                                    <button class="btn btn-dark" type="submit" style="margin-left: 300px; margin-bottom: 10px"  aria-hidden="true">
